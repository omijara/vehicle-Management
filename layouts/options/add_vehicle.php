...
<div class="col-md-11">
<h5 class="card-header">Add New Vehicle</h5>
...
<div class="card-body">
  ...
  <label for="name">Vehicle No<span class="text-danger">*</span></label>
  <input type=text value=""
  placeholder="Enter Vehicle no" id="name"
  class="form-control " name="vehicle_no" min="0" max="" required>
  <small class="help-text text-muted">Enter Vehicle No.</small>
  </div>
  ...
  <button type="submit" name="vehicle" class="btn btn-sm btn-primary"><i class="fas fa-download"></i> Save</button>
