          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Problems List View</h3>
              </div>
              ...
              <div class="card-body">
                ...
                <a href="add_problem.php" type="submit" name="save" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Add</a>
                </div>
                  <style>
                  table {
                ...
                <?php 
                  ...
                  $no=1;
                  while ($rows = mysqli_fetch_array($problem_list)) {

                ?>
                  <tr>
                    <td><?php echo $no. "</br>"; ?></td>
                   <td><?php echo $rows['problem_list']?></td>
                    <td> <?php           
