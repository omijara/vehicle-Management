          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Approver List view</h3>
              </div>
              ...
              <div class="card-body">
                ...
                <a href="add_approver.php" type="submit" name="save" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Add</a>
                </div>
                  <style>
                  table {
               ...
               <!--      <th>Project</th> -->
                ...
                <?php 
                  ...
                  $no=1;
                  while ($rows = mysqli_fetch_array($approver_list)) {

                ?>
                  <tr>
                    <td><?php echo $no. "</br>"; ?></td>
                   <td><?php echo $rows['a_name']?></td>
                   <td><?php echo $rows['a_designation']?></td>
                  <!--  <td></td> -->
                    <td> <?php           
                  ...
                  echo "<a onClick=\"javascript: return confirm('Are you sure want to delete this record?');\" class= 'dropdown-item' href='delete.php?approver_ID=".$rows["approver_id"]."'>"?><i class="fa fa-trash" style="color:red"></i> Delete</a>
                    </div>
                    </td> 
                    </tr>
