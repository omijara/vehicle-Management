          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Driver List View</h3>
              </div>
              ...
              <div class="card-body">
                ...
                <a href="add_driver.php" type="submit" name="save" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Add</a>
                </div>
                  <style>
                  table {
                ...
                <?php 
                  ...
                  $no=1;
                  while ($rows = mysqli_fetch_array($driver_list)) {
