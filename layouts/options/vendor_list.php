        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Repair vendor</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Repair vendor List</h3>
              </div>
              ...
              <div class="card-body">
                ...
                <?php 
                  ...
                  $no=1;
                  while ($rows = mysqli_fetch_array($vendor)) {
                ...
                ?>
                  ...
                  <?php  
                  $localIP = $localIP = $_SERVER["REMOTE_ADDR"];
