          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="add_item.php" type="submit" name="save" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Add</a>
                </div>
                  <style>
                  table {
                ...
                <?php 
                  ...
                  $no=1;
                  while ($rows = mysqli_fetch_array($item_list)) {
                ...
                ?>
                  ...
                  ?></td>
                    ...
                    <a class="dropdown-item" href="edit.php?editId=<?php echo $rows["id"]?>"><span class="fa fa-edit text-primary"></span> Edit</a>
                  ...
                  echo "<a onClick=\"javascript: return confirm('Are you sure want to delete this record?');\" class= 'dropdown-item' href='delete.php?problem_ID=".$rows["id"]."'>"?><i class="fa fa-trash" style="color:red"></i> Delete</a>
                    </div>
                    </td> 
                    </tr>
