...
<div class="col-md-11">
<h5 class="card-header">Add Recommender</h5>
...
<div class="card-body">
  ...
  <label for="name">Recommender Name<span class="text-danger">*</span></label>
  <input type=text value=""
  placeholder="Enter recommender name" id="name"
  class="form-control " name="name" min="0" max="" required>
  <small class="help-text text-muted">Enter recommender name.</small>
  </div>
  ...
  <button type="submit" name="recommender" class="btn btn-sm btn-primary"><i class="fas fa-download"></i> Save</button>
  <a href="recommender_list.php" type="submit" name="data" class="btn btn-sm btn-secondary"></i> Cancel</a>
  </div>
  </div>
  </form>
</div>
