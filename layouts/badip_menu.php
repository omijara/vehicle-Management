          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                ...
                <a href="maintenance_report.php?project=Badip" class="nav-link">
              ...
              <li class="nav-item">
                ...
                <a href="fuel_report.php?project=Badip" class="nav-link">
...
<!-- 
              <li class="nav-item">
                ...
                <a href="edit_maintenance_report.php" class="nav-link">
