	...
	<body>
		<div class="invoice-box">
				...
				<tr class="top">
					<td colspan="2">
						<table>
							<tr>
								<td class="title">
									<img src="../../dist/img/logo_swisscontact.svg" style="width: 100%; max-width: 200px"f/>
								</td>
			...
			<!-- 	<tr class="details">
				...
				<tr class="item">
					<td>Fuel Quantity (Liter)</td>

					<td><?php echo $data['current_quantity'] ?>L</td>
			
				</tr>

				<tr class="item">
					<td>Fuel Filling Meter Reading and Date</td>

					<td><?php echo $data['current_reading'] ?>km on 
						<?php 					
					$timeStamp = $data['cur_date'] ;
				...
				<tr class="item">
					<td>Last Fuel Filling Meter Reading and Date</td>

					<td><?php echo $data['previous_reading'] ?>km on 
					<?php 					
					$timeStamp = $data['last_date'] ;
					$timeStamp = date( "d/m/Y", strtotime($timeStamp));
					echo $timeStamp;
					?>
				...
				<tr class="item last">
					...
					<td><?php echo $data['fuel_vendor'] ?></td>
