...
//Edit customer record
 if(isset($_GET['userId']) && !empty($_GET['userId'])) {
      $userId= $_GET['userId'];
      $data= $obj->print_maintenance_data($userId);
  }
...
<html>
	...
	<!-- 	<div>
			...
			<!-- 	<tr class="details">
				...
				<tr class="item">
					<td>Previous Meter Reading & Date:</td>

					<td><?php echo $data['previous_reading'] ?>km on 
						<?php 					
					$timeStamp = $data['previous_date'] ;
				...
				<tr class="item">
					<td>Current Meter Reading & Date:</td>

					<td><?php echo $data['current_reading'] ?>km on 
					<?php 					
					$timeStamp = $data['curr_date'] ;
					$timeStamp = date( "d/m/Y", strtotime($timeStamp));
					echo $timeStamp;
					?>
				...
				<tr class="item">
					...
					<td><p><?php 
					$problem = str_replace(",","<br>",$data['problems']);
