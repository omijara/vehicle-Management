...
$obj = new Model;
$show = $obj->show_maintenance_data();
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="maintenance_form.php" type="submit" name="save" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Add</a>
                </div>
                  <style>
                  table {
                ...
                ?>
                  <tr>
                   ...
                   <button data-id='<?php echo $rows["id"]?>' class='dropdown-item fas fa-eye userinfo'> View</button>
                    ...
                    <div class="dropdown-divider"></div>
                   <a class="dropdown-item" href="modal/maintenance_pdf.php?userId=<?php echo $rows["id"]?>" target="_blank"><span class="fa fa-print text-primary"></span> Print</a>
                    <div class="dropdown-divider"></div>
             ...
             <?php if ($_SESSION['user_level'] === 'ba'){ ?> 
                   <a class="dropdown-item" href="maintenance_edit.php?editId=<?php echo $rows["id"]?>"><span class="fa fa-edit text-primary"></span> Edit</a>
                    <div class="dropdown-divider"></div>

                  <?php  

                    echo "<a onClick=\"javascript: return confirm('Are you sure want to delete this record?');\" class= 'dropdown-item' href='delete.php?deleteId=".$rows["id"]."'>"?><i class="fa fa-trash" style="color:red"></i> Delete</a>
                 <?php    } ?>
                    </div>
                    </td> 
                    </tr>
